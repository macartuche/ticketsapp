 ...
 * @author macbookpro
 */
public class EntryParkingForm1 extends javax.swing.JDialog {
     ...
     */
    public EntryParkingForm1(java.awt.Frame parent, boolean modal, Billing b) {
        super(parent, modal);
        initComponents();
...
//            detailController.create(detail);
            ...
            Logger.getLogger(EntryParkingForm1.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
...
//            JasperPrintManager.printReport(jasperPrint, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntryParkingForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EntryParkingForm1 dialog = new EntryParkingForm1(new javax.swing.JFrame(), true, null);
