...
//        printBTN.setEnabled(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (index != -1) {
            ...
            mainForm.CerrarPestana(TabsIndex.REPORTES_VENTASREALIZADAS.getIndex());
        }
    }                                        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Query q = controller.getEntityManager().createQuery("SELECT b FROM Billing b"
                ...
                + " lower(b.clientProviderid.personId.lastname) like :criteria)  and b.state=:state "
                + " and b.collectorPerson=:user order by b.emissiondate desc");
        ...
        q.setParameter("user", LoginApp.userLogged.getId());
    ...
    private List<Object[]> getBillingsByDatesAndState(Calendar start, Calendar end, String state) {
        ...
        String query = "select sum(d.total),   d.unitaryPrice,  d.productId, sum(d.quantity) "
                ...
                + "and :end  and  d.billingId.state=:state  and d.billingId.collectorPerson=:user "
...
//            viewer.setVisible(true);
     ...
     * @param evt
     */
    private void printTicketsBTNActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if (!billings.isEmpty()) { 
            
            //verificar que no exista tickets en estado generado
            Map<String, Object> filters = new HashMap<>();
            
            /*
            Query q = controller.getEm().createQuery("Select b from Billing b "
                    + " WHERE b.state=:state and b.emissiondate>=:currentDate");
            q.setParameter("state", "GENERADA");
            q.setParameter("currentDate", new Date());
            List<Billing> bills = q.getResultList();
            */
...
//            String reportPath = Utilitario.getValue("pathTest") + "ventasA7Tickets.jasper";
     ...
     */
    private void printAnuladosBTNActionPerformed(java.awt.event.ActionEvent evt) {   
        if (billings != null && !billings.isEmpty()) {
            String reportPath = Utilitario.getValue("pathJasper") + "anuladosA7Tickets.jasper";
